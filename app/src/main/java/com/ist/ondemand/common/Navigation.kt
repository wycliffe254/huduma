...
import com.ist.ondemand.presentation.screens.main.NewServiesScreen
...
fun DemandApp() {
    ...
    NavHost(navController = navController, startDestination = Routes.Signup.route) {
        ...
        composable(Routes.NewServices.route) {
            NewServiesScreen(navController = navController, vm = vm, encodedUri = "")
        }
