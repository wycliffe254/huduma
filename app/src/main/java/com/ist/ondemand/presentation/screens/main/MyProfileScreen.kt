...
@Composable
fun MyProfileScreen(navController: NavController, vm: MainViewModel, it: String) {
    ...
    if (isLoading) {
        ...
        Log.d("prof", "name: $email, username: $username, bio: $bio")
        ProfileContent(
            vm = vm,
            email = email,
            username = username,
 ...
 * @param onEmailChange The callback function for name change.
...
//wicky123 wycliffekamba81@gmail.com laundry
        Row(
            modifier = Modifier
                .fillMaxWidth()
